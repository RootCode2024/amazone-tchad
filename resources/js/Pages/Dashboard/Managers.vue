<template>
    ...
    <div v-if="isModalOpen" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
        ...
        <form @submit.prevent="storeManager" class="mt-4">
          <div class="py-2">
            <label for="departure_date">Nom Complet</label>
            <input type="text" v-model="newManager.name" class="w-full border p-2 rounded-lg" />
          </div>
          <div class="py-2">
            <label for="email">Email</label>
            <input type="email" v-model="newManager.email" class="w-full border p-2 rounded-lg" />
          </div>
          <div class="py-2">
            <label for="address">Adresse</label>
            <input type="address" v-model="newManager.address" class="w-full border p-2 rounded-lg" />
          </div>
  ...
  // 🔹 Ouvrir la modale pour ajouter un manager
  const openAddModal = () => {
