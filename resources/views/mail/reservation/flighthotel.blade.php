    ...
    <table align="center" width="100%" cellspacing="0" cellpadding="0">
        ...
        <td align="center">
            ...
            <tr>
                ...
                <h2 style="color: #1e40af; font-size: 24px;">✈️ Nouvelle réservation de vol + hotel</h2>
                <p style="color: #374151; font-size: 16px;">Bonjour <strong>Admin</strong>,</p>
                <p style="color: #4b5563;">Une nouvelle réservation de vol + hotel a été soumise sur <strong>Amazone Tchad</strong>. Voici les détails :</p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <table width="100%">
                    ...
                    <td style="padding: 10px 0; color: #1e40af;">FLH{{ $reservation->id }}</td>
                    </tr>
                    <tr>
