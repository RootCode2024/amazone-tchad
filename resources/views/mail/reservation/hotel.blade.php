    ...
    <table align="center" width="100%" cellspacing="0" cellpadding="0">
        ...
        <td align="center">
            ...
            <tr>
                ...
                <h2 style="color: #1e40af; font-size: 24px;">Nouvelle réservation d'hotel</h2>
                <p style="color: #374151; font-size: 16px;">Bonjour <strong>Admin</strong>,</p>
                <p style="color: #4b5563;">Une nouvelle réservation d'hotel a été soumise sur <strong>Amazone Tchad</strong>. Voici les détails :</p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <table width="100%">
                    ...
                    <td style="padding: 10px 0; color: #1e40af;">HO{{ $reservation->id }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <td style="padding: 10px 0;"><strong>Lieu :</strong></td>
                    <td style="padding: 10px 0;">{{ $reservation->country->name }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 0;"><strong>Nombre de chambre :</strong></td>
                        <td style="padding: 10px 0;">{{ $reservation->number_of_room }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 0;"><strong>Date de d'arrivée & de retour :</strong></td>
                        <td style="padding: 10px 0;">{{ $reservation->arrival_date }} - {{ $reservation->return_date }}</td>
                    </tr>
                    <tr>
                </table>
                </td>
